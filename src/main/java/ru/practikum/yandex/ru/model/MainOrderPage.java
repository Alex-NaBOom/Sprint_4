...
public class MainOrderPage {
    ...
    public String fillingFieldFistName(String name) {
    ...
    public String fillingFieldSurname(String surname) {
    ...
    public String fillingFieldAdress(String adress) {
    ...
    public String fillingFieldPhoneNumber(String phoneNumber) {
    ...
    public String fillingFieldWhen(String when) {
    ...
    public String filingFieldComment(String textComment) {
